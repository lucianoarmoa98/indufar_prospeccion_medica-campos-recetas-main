...
export const REMOVE_MENU_CHILDREN_NAVIGATION =
  '[NAVIGATION] REMOVE MENU CHILDREN NAVIGATION';
...
export function removeNavigationMenuChildren(menu, roles) {
  return (dispatch) => {
    return dispatch({
      type: REMOVE_MENU_CHILDREN_NAVIGATION,
      payload: {
        menu,
        roles
      }
