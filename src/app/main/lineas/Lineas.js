...
import * as lineasActions from './store/actions';
// Material UI.
...
import { configuracionDeTabla, END_POINT_LINEAS } from './LineasConfig';
...
class Lineas extends React.Component {
    ...
    componentDidUpdate(prevProps) {
        ...
        const { lineas: { sincronizacion, cantidadPorSincronizar } } = this.props;
    ...
    render() {
        ...
        const { lineas: { list }, listChangePage, listChangeQuantityPerPage, setSearchValue, history } = this.props;
                        ...
                        <div>
                            <div className="p-24" >
                                ...
                                <MaterialTable
                                    ...
                                    data={query => (
                                        new Promise(resolve => {
                                            let url = construirParametrosDePaginacion(query, END_POINT_LINEAS);
                                            fetch(url)
...
function mapStateToProps({ lineas }) {
    return { lineas };
}
...
function mapDispatchToProps(dispatch) {
    ...
    return bindActionCreators(
        {
            setCantidadPorSincronizar: lineasActions.setCantidadPorSincronizar,
            getCantidadPorSincronizar: lineasActions.getCantidadPorSincronizar,
            resetSincronizacion: lineasActions.resetSincronizacion,
            sincronizar: lineasActions.sincronizar,
            listChangePage: lineasActions.listChangePage,
            listChangeQuantityPerPage: lineasActions.listChangeQuantityPerPage,
            setSearchValue: lineasActions.setSearchValue
        },
        dispatch);
}
